...
export default function QuestionEditor(prop: Readonly<PropQuestionEditor>) {
  ...
  const [type, setType] = useState<QuestionType>(prop.question.type ?? "RADIO");
  ...
  return (
    ...
    <div className="form-control">
    <p className="label">
    <span className="label-text font-semibold">Type de question</span>
    </p>
    <select
    ...
    <option value="MULTIMEDIA">Question multimédia (image / vidéo)</option>
    </select>
    </div>
